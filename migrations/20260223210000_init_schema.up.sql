...
CREATE INDEX idx_opportunities_canonical_key ON opportunities (canonical_key);
CREATE INDEX idx_opportunities_apply_url ON opportunities (apply_url);
CREATE INDEX idx_raw_artifacts_content_hash ON raw_artifacts (content_hash);
CREATE INDEX idx_opportunity_versions_created_at ON opportunity_versions (created_at);
